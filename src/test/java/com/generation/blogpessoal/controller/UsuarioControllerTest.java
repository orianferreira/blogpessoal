...
public class UsuarioControllerTest {
	...
	public void deveAtualizarUmUsuario() {
		...
		Optional<Usuario> usuarioCreate = Optional.ofNullable(usuarioService.CadastrarUsuario(new Usuario(0L,
	...
	private void assertEquals(String usuario, String usuario2) {
	...
	private void assertEquals(HttpStatus ok, HttpStatus httpStatus) {
		// TODO Auto-generated method stub
